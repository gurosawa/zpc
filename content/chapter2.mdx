...
status: "draft"
guiding_question: "브라우저와 서버는 HTTPS 연결에서 무엇을 검증하고 무엇을 숨기는가?"
reader_promise: "TLS 핸드셰이크, 인증서, 키 교환, 레코드 보호가 하나의 신뢰 계층으로 맞물리는 흐름을 설명할 수 있습니다."
expected_words: 3200
draft_outline:
  - "TLS는 웹의 기본 신뢰 계층입니다"
  - "HTTPS와 TLS의 역할"
...
illustration_idea: "ClientHello에서 encrypted response까지 이어지는 TLS record strip."
interactive_idea: "핸드셰이크 단계별 메시지를 클릭하면 transcript 조각이 누적되는 미니 타임라인."
visual_key: "tls-record-strip"
---
