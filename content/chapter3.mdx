...
status: "draft"
guiding_question: "적게 공개하면서도 검증 가능성을 유지하려면 어떤 증명 도구가 필요한가?"
reader_promise: "영지식 증명, SNARK/STARK, MPC, garbled circuit이 zkTLS에서 맡는 역할을 구분할 수 있습니다."
expected_words: 3400
draft_outline:
  - "덜 공개하고도 더 확실히 검증하기"
  - "영지식 증명의 세 가지 감각"
...
illustration_idea: "private input, circuit, proof, verifier를 연결한 constraint grid."
interactive_idea: "간단한 조건식의 private/public 입력을 바꿔 proof statement가 어떻게 달라지는지 보여줍니다."
visual_key: "circuit-grid"
---
...
<ArtifactDiagram visualKey="circuit-grid" label="비공개 입력, 공개 입력, 회로, 증명, 검증기" />
...
<ArtifactDiagram visualKey="circuit-grid" label="Client share와 Notary share가 회로 계산으로 합쳐지는 구조" />
